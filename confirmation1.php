<?php
    ...
    $QTDD = $_POST['QTDD'];
            ...
            $result = mysqli_query($conexao, "INSERT INTO rsvp(FNAME,EMAIL,
            IDADE,TELEFONE,CPF,ALERGIA,QUAL,FAMILIA,CONVIDADO,QTDD)
             VALUES('$FNAME', '$EMAIL', '$IDADE', '$TELEFONE', '$CPF', '$ALERGIA', '$QUAL', '$FAMILIA', '$CONVIDADO', '$QTDD')" );
        ?>
